...
<div class="d-flex justify-content-center align-itens-center">
  <form class="p-5 rounded shadow" action="cadastrar-cliente.php" method="post" style="width: 30rem;">
    ...
    <h2 class="text-center pb-5 display-4">Cadastro do produto concluído</h2>

    <h5><a href="cadastroproduto.php" class="btn btn-primary">Retornar para a página de cadastro...</a></h5>
