  ...
  <header class="container-fluid">
    ...
    <nav class="navbar navbar-expand-md navbar-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="projeto.html"><img src="img/logo3.svg" width="300px" height="130px" alt="logo do site, quadro em canvas com star frame pintado"></a> <!--logo do site-->
...
<div class="container">
  ...
  <footer class="container-foot text-center text-white" > <!-- Footer -->
    ...
    <section class="mapa"> <!--section Google Maps-->
      ...
      <a class="navbar-brand" href="projeto.html"><img src="img/logo3.svg" width="300px" height="230px" alt="logo do site, quadro em canvas com star frame pintado" id="logofooter"></a>
