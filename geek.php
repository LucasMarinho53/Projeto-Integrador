...
<body>
  ...
  <section class="container">
    ...
    <table>
      <tr>
        <td><img  class="shadow p-3 mb-5 bg-body rounded" style="margin-top: 30px;" width="400px" alt="Quadro - Fantasminhas do Pac-man - Fantasmas verde laranja e amarelo ao redor de uma fogueira contando história de terror sobre o pacman." src='img/GEEK/geek1.webp'/></td>
    ...
    <table>
      <tr>
        <td><img  class="shadow p-3 mb-5 bg-body rounded" style="margin-top: 30px;" width="400px" alt="Quadro - Super Mario Bros - Somente a cara do Mario num fundo vermelho." src='img/GEEK/geek2.webp'/></td>
    ...
    <table>
      <tr>
        <td><img  class="shadow p-3 mb-5 bg-body rounded" style="margin-top: 30px;" width="400px" alt="Quadro - Star Wars -R2D2 - R2D2 num fundo amarelo com cenas classicas da franquia pintadas dentro dele." src='img/GEEK/geek3.jfif'/></td>
   ...
   <table>
      <tr>
        <td><img  class="shadow p-3 mb-5 bg-body rounded" style="margin-top: 30px;" width="400px" alt="Quadro - Herói e Vilão de Gotham City - Batman e Coringa - Quadro representando a dualidade do batman e do coringa, com metade do rosto de cada se juntando para formar um unico rosto." src='img/GEEK/geek4.webp'/></td>
