...
<div class="container">
        <fieldset>
            <legend><strong>Meu Perfil</strong></legend>
            <form>
</br>
            <div class="form-group">
                <label  class = "form-control" for="nome_id"><strong>Nome: <?PHP echo  $nome; ?> </strong></label>
            </div>
</br>
            <div class="form-group">
                <label class = "form-control" for="email_id"><strong>Email: <?PHP echo  $email; ?> </strong></label>
            </div>
</br>
            <div class="form">
                <label class = "form-control" for="cpf_id"><strong>CPF: <?PHP echo  $CPF; ?> </strong></label>
            </div>
</br>
            <button> <a href ="logout.php" class="btn btn-primary"> SAIR </a> </button>
            </form>
        </fieldset>
    </div>
</section>
    ...
    <footer style = "margin-top: 200px;" class="container-foot text-center text-white"> <!-- Footer -->
